...
\begin{document}
    ...
    \begin{tikzpicture}
		\begin{loglogaxis}[ 
            ...
            title={$\mathbf{A}(\mathbf{B} \otimes \mathbf{C})$ where $\mathbf{A} \in \mathbb{R}^{5 \times 25}$, and $\mathbf{B},\mathbf{C}:[0,1] \to \mathbb{R}^{5 \times 5}$},
